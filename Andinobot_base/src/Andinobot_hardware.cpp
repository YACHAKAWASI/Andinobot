#include "Andinobot_base/Andinobot_hardware.hpp"

namespace Andinobot_base
{

    AndinobotHardware::AndinobotHardware()
    : logger_(rclcpp::get_logger("AndinobotHardware"))
{}

CallbackReturn AndinobotHardware::on_init(const hardware_interface::HardwareInfo & info)
{
...
std::vector<hardware_interface::StateInterface> AndinobotHardware::export_state_interfaces()
{
...
std::vector<hardware_interface::CommandInterface> AndinobotHardware::export_command_interfaces()
{
...
CallbackReturn AndinobotHardware::on_configure(const rclcpp_lifecycle::State & /*previous_state*/)
{
...
CallbackReturn AndinobotHardware::on_activate(const rclcpp_lifecycle::State & /*previous_state*/)
{
...
CallbackReturn AndinobotHardware::on_deactivate(const rclcpp_lifecycle::State & /*previous_state*/)
{   
...
return_type AndinobotHardware::read(const rclcpp::Time & /*time*/, const rclcpp::Duration & period)
{
    // Obtain elapsed time
...
return_type AndinobotHardware::write(const rclcpp::Time & /*time*/, const rclcpp::Duration & period)
{   
...
PLUGINLIB_EXPORT_CLASS(
    Andinobot_base::AndinobotHardware, 
